...
public class Item extends Object {
	...
	/**
	  ...
	  *
	  * @param b the Block that is being added to the editor
	  * @param e the Ellipse2D.Double corresponding to that Block
	  */
	...
	/**
	  ...
	  *
	  * @param i the location of the parent
	  * @return Item
	  */
	...
	/**
	  ...
	  *
	  * @param i the Item to add onto the parent list
	  */
	...
	/**
	  ...
	  *
	  * @param i the Item to add onto the child list
	  */
	...
	public void print() {
		System.out.println("---nodename : "+b.getBlockName());
                System.out.println("---node position : "+Double.toString(e.getX()) +" ,"+Double.toString(e.getY()));
	}
}
